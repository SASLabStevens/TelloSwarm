""" python set-ap-mode.py -s [SSID] -p [PASSWORD]
 ...
 NOTE: the Wi-Fi network must be 2.4 GHz for Tello EDU to connect to it.

Ref. https://tello.oneoffcoder.com/swarm.html#set-tello-modes
...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(
        "set-ap-mode.py", epilog="setting Tello EDU in AP mode"
    )
