...
```
git clone https://github.com/m-bahrami/vicon_bridge && git clone https://github.com/SASLabStevens/TelloSwarm -b dev
```
...
We will use **a list of names**, assigned to the drones in the VICON Tracker software, as the **identifiers** of drones in Python programming. Particularly, the Python module `mocap.py` uses this list to obtain the ground truth pose of the drones tracked by the motion capture system.
